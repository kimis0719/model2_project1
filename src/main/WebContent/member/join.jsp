			...
			<table class="table table-bordered table-hover" style="text-align: center; border: 5px solid #dddddd">
				...
				<tbody>
					...
					<tr>
						...
						<td><input class="form-control" type="password" id="mem_pass1" name="mem_pass1" placeholder="비밀번호" maxlength="20"></td>
					</tr>
					<tr>
						<td style="width:110px;"><h6>비밀번호 확인</h6></td>
						<td><input class="form-control" type="text" id="mem_pass2" name="mem_pass2" placeholder="비밀번호 확인" maxlength="20"></td>
					</tr>
					<tr>
