...
<div class="container">
		...
		<form method="post" action="<%=request.getContextPath() %>/Update.Mypage">
			<input type ="hidden" name="mem_id" value="${member1.mem_id}">
			<input type ="hidden" name="mem_num" value="${member1.mem_num}">
