...
<body>
	<div id="popWrap">
						...
						<table class="tbl">
							...
							<!-- 제목 -->
								...
								<tr>
									...
									<td class="alignL">
										<textarea name="qna_content" id="popCont" rows="10" cols="80" placeholder="답변 내용을 작성해 주세요">${answer.qna_content}</textarea>
									</td>
								</tr>
							</tbody>
						</table>
			...
			<!-- 버튼 -->
				<div class="btn_wrap">
					<input type="hidden" name="qna_num" value="${answer.qna_num}">
